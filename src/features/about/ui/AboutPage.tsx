      ...
      <section className={s.section}>
        ...
        <div className={s.aboutText}>
          <p>
            ...
            on the commercetools platform. Our team built the store using a lightweight tech stack: React, Zustand, React Router, Swiper, React Hook Form, and Zod. With no final UI mockups, we relied on open communication, shared ideas, and each teammate’s creative input to shape the product collaboratively.
          </p>
